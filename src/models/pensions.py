...
class subscriptions(Base):
    ...
    id_subscriptions = Column(Integer, primary_key=True, autoincrement=True, nullable=False)
...
class cancellations(Base):
    ...
    client_id = Column(Integer, ForeignKey("Client.client_id"), nullable=False)
    fund_id = Column(Integer, ForeignKey("Funds.fund_id"), nullable=False)
    id_subscriptions = Column(Integer,ForeignKey("Subscriptions.id_subscriptions"), nullable=False)
...
class transactions(Base):
    ...
    id_subscriptions = Column(Integer, ForeignKey("Subscriptions.id_subscriptions"), nullable=False)
    cancelled_id = Column(Integer, ForeignKey("Cancellations.cancelled_id"), nullable=False)
    client_id = Column(Integer, ForeignKey("Client.client_id"), nullable=False)
    fund_id = Column(Integer, ForeignKey("Funds.fund_id"), nullable=False)
...
class notifications(Base):
    ...
    id_notifications  = Column(Integer, primary_key=True, autoincrement=True, nullable=False)
    client_id = Column(Integer, ForeignKey("Client.client_id"), nullable=False)
    cancelled_id= Column(Integer, ForeignKey("Cancellations.cancelled_id"), nullable=False)
    id_subscriptions = Column(Integer, ForeignKey("Subscriptions.id_subscriptions"), nullable=False)
